      ...
      if (profilesSnap.exists() && profilesSnap.data().list) {
        ...
        for (const pData of cloudProfiles) {
          ...
          for (const favDoc of favSnap.docs) {
            ...
            if (type === 'movie') await localDbInstance.addFavoriteMovie(fData);
            else if (type === 'series') await localDbInstance.addFavoriteSeries(fData);
            else if (type === 'live') await localDbInstance.addFavoriteLive(fData);
          }
        }
      } else {
